                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.store.about.galary') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <label for="about_galary_text">About Galary Text  <strong class="text-danger">*</strong></label>
                                    ...
                                    <div class="col-lg-6">
                                        <label for="about_galary_img">
                                            select an image <strong class="text-danger">*</strong> <br>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea rows="30" name="about_institute" id="about_institute" class="form-control"
                                            placeholder="about institute....." cols="30" rows="10"></textarea>
                                    </div>
